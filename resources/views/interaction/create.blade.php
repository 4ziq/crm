                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="relative mt-1">
                                    ...
                                    <x-text-input id="interaction_date" name="interaction_date" type="text"
                                        {{-- Change to text for Flatpickr --}} :value="old('interaction_date', date('Y-m-d'))" class="pl-10 block w-full"
                            ...
                            <div>
                                ...
                                <select name="type" id="type"
                                    class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                    <option value="call" {{ old('type') == 'call' ? 'selected' : '' }}>Call
                                    </option>
